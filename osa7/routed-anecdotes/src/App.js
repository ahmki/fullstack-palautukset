  ...
  return (
    <Router>
      ...
      <Switch>
        ...
        <Route path="/create">
          <CreateNew addNew={props.addNew} setNotification={props.setNotificationTimeout}/>
        </Route>
        <Route path="/about">
          <About />
        </Route>
...
const CreateNew = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    props.setNotification(content.form)
    history.push('/')
  }
...
const App = () => {
  ...
  // Ilmoitus 10 sekunnin ajastimella
  const setNotificationTimeout = (content) => {
